...
module load_fsm #(
    ...
    logic [READ_LATENCY - 1 : 0] cs_pipeline;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            valid_pipeline<= {valid_pipeline[READ_LATENCY - 2 : 0], fsm_valid};
            cs_pipeline   <= {cs_pipeline[READ_LATENCY - 2 : 0], fsm_cs};
    ...
    assign sram_cs_out = cs_pipeline[READ_LATENCY - 1] | fsm_cs;
